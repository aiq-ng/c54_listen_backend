...
INSERT INTO listen_streams (category_id, name, description, thumbnail, stream_url) VALUES
    ...
    (1, 'Concert Stream', 'Live music performances from artists worldwide', 'https://images.pexels.com/photos/755416/pexels-photo-755416.jpeg?auto=compress&cs=tinysrgb&w=800', 'http://live.example.com/concert'), -- Image4
    (1, 'Sports Commentary', 'Real-time commentary on major sports events', 'https://images.pexels.com/photos/302655/pexels-photo-302655.jpeg?auto=compress&cs=tinysrgb&w=800', 'http://live.example.com/sports'), -- Image2
    -- Podcast (category_id: 2)
    (2, 'Tech Talk', 'Weekly discussions on technology trends', 'https://images.pexels.com/photos/6686442/pexels-photo-6686442.jpeg?auto=compress&cs=tinysrgb&w=800', 'http://live.example.com/sports'), -- Image5
    (2, 'True Crime Files', 'Deep dives into unsolved mysteries', 'https://images.pexels.com/photos/6878179/pexels-photo-6878179.jpeg?auto=compress&cs=tinysrgb&w=800', 'http://live.example.com/sports'), -- Image3
    (2, 'Health Matters', 'Expert advice on wellness and fitness', 'https://images.pexels.com/photos/6892712/pexels-photo-6892712.jpeg?auto=compress&cs=tinysrgb&w=800', 'http://live.example.com/sports'), -- Image2
    -- Showcast (category_id: 3)
    (3, 'Morning Mix', 'A blend of live chats and pre-recorded segments', 'https://images.pexels.com/photos/6686439/pexels-photo-6686439.jpeg?auto=compress&cs=tinysrgb&w=800', 'http://live.example.com/sports'), -- Image1
    (3, 'Comedy Hour', 'Stand-up specials with live audience reactions', 'https://images.pexels.com/photos/3783471/pexels-photo-3783471.jpeg?auto=compress&cs=tinysrgb&w=800', 'http://live.example.com/sports'), -- Image4
    -- Limited Series (category_id: 4)
    (4, 'History Unraveled', 'A 5-part series on historical events', 'https://images.pexels.com/photos/6883809/pexels-photo-6883809.jpeg?auto=compress&cs=tinysrgb&w=800'), -- Image3
    (4, 'Sci-Fi Tales', 'A 6-episode journey through science fiction stories', 'https://images.pexels.com/photos/18653022/pexels-photo-18653022/free-photo-of-microphone-in-black-and-white.jpeg?auto=compress&cs=tinysrgb&w=800', 'http://live.example.com/sports'); -- Image5
